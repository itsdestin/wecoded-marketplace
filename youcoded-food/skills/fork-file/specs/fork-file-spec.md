...
| Approval-before-write pattern | Matches the convention established by other YouCoded skills (journaling, encyclopedia). Users must see exactly what will be written and confirm. | Auto-write with undo (rejected: inconsistent with toolkit conventions, higher risk of bad data) |
