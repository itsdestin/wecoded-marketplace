// Privacy-by-construction contract (see docs/PITFALLS.md analytics section when added):
// every query in this file aggregates install_id via COUNT_DISTINCT or omits it
// from SELECT entirely. Raw install_ids never leave the Worker — don't add a route
