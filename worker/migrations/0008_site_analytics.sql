...
-- WHY parenthesized CASE: remote D1 /query otherwise treats its END as the trigger END
-- (workers-sdk#4727); local SQLite and Wrangler's local splitter do not catch this.
